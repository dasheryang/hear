...
public class MasterLayout extends FrameLayout implements OnClickListener {
	...
	private Path stop, tick, play, download_triangle, download_rectangle,stop1;
	...
	private void initialise() {
		cusview = new CusImage(getContext(), this,pix);
	...
	private void setpaint() {
        ...
        //stroke_color.setColor(Color.rgb(0xe8,0xba,0x00));
        stroke_color.setColor(Color.rgb(0x23,0x22,0x22));
														// the circle color
		stroke_color.setStrokeWidth(7);
        ...
        icon_color.setColor(Color.rgb(0xe8,0xba,0x00));
        icon_color.setStrokeWidth(3);
        ...
        fill_color.setColor(Color.rgb(0xe8, 0xba, 0x00));
	...
	private void setAnimation() {
		...
		out.setAnimationListener(new AnimationListener() {
			...
			public void onAnimationEnd(Animation animation) {
				...
				buttonimage.setImageResource(R.drawable.pause_icon);
		...
		new_scale_in.setAnimationListener(new AnimationListener() {
			...
			public void onAnimationEnd(Animation animation) {
				...
				buttonimage.setVisibility(View.VISIBLE);
				buttonimage.setImageResource(R.drawable.play_icon);
				flg_frmwrk_mode = 3;
				buttonimage.startAnimation(in);
	...
	private void displayMetrics() {
		...
		*/
        ...
        //58dp
        pix= UIHelper.dip2px(getContext(),68);
	}
	...
	private void iconCreate() {
		...
		*/
		...
		stop.moveTo(pix * 42 / 100, pix * 38 / 100);
		stop.lineTo(pix * 42 / 100, pix * 62 / 100);
        stop.close();


        stop1=new Path();
		stop1.moveTo(pix * 58 / 100, pix * 38 / 100);
		stop1.lineTo(pix * 58 / 100, pix * 62 / 100);
		stop1.close();
	...
	public void init() {
		...
		second_icon_canvas.drawLine(42*pix/100,38*pix/100,42*pix/100,62*pix/100, icon_color);  // Draw second icon on canvas( Default - Stop ).
														// *****Set your second icon here****

        second_icon_canvas.drawLine(58*pix/100,38*pix/100,58*pix/100,62*pix/100, icon_color);  // Draw second icon on canvas( Default - Stop ).
    ...
    public void initAnimation() {
        if(loadingAnimation==null) {
            loadingAnimation=AnimationUtils.loadAnimation(this.getContext(), R.anim.tip);
    ...
    public void startLoading(){
        initAnimation();
        buttonimage.setImageResource(R.drawable.progress_animated);
        buttonimage.startAnimation(loadingAnimation);
    }
